      ...
      >
        <Providers themeProps={{ attribute: "class", defaultTheme: "dark" }}>
          <div className="relative flex flex-col min-h-screen">
            ...
            <div className="absolute inset-0 bg-[url('/assets/vectors/kitty.png')] dark:bg-[url('/assets/vectors/kuromi.png')] bg-repeat bg-[length:400px_400px] opacity-35 dark:opacity-15 pointer-events-none z-0" />
              {/* Main Content */}
              <main
                className={
